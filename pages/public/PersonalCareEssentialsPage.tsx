...
const PersonalCareEssentialsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'personal-care-essentials' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-rose-50">
                     <img src="https://picsum.photos/seed/pcare-hero/1920/1080" alt="Personal care items" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-rose-900">Daily Essentials</h1>
                        <p className="mt-4 text-lg max-w-xl text-rose-800">All your personal care needs, from dental to skincare, in one place.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Personal Care" linkTo="/browse?category=personal-care-essentials" />
...
export default PersonalCareEssentialsPage;