...
const PackagedFoodPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'packaged-food' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-orange-100">
                     <img src="https://picsum.photos/seed/packaged-hero/1920/1080" alt="Well-stocked pantry" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/20">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-white">Pantry Staples</h1>
                        <p className="mt-4 text-lg max-w-xl text-gray-100">Stock up on long-lasting essentials, from canned goods to pasta and grains.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Packaged Food" linkTo="/browse?category=packaged-food" />
