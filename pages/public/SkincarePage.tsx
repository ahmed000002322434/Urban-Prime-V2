...
const SkincarePage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'skincare' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-green-50">
                     <img src="https://picsum.photos/seed/skincare-hero/1920/1080" alt="Skincare products" className="absolute inset-0 w-full h-full object-cover opacity-80"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-green-900">Nourish Your Skin</h1>
                        <p className="mt-4 text-lg max-w-xl text-green-800">Discover gentle, effective skincare for a healthy, radiant glow.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    <section>
                        <SectionHeader title="Shop Skincare" linkTo="/browse?category=skincare" />
