...
const PetFoodPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'pet-food' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-amber-100">
                     <img src="https://picsum.photos/seed/petfood-hero/1920/1080" alt="Happy dog with a bowl of food" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/20">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-white">For Your Best Friend</h1>
                        <p className="mt-4 text-lg max-w-xl text-gray-100">Nutritious and delicious food to keep your pets happy and healthy.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Pet Food" linkTo="/browse?category=pet-food" />
