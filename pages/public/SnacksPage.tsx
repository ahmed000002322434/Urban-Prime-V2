...
const SnacksPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'snacks-confectionery' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-yellow-100">
                     <img src="https://picsum.photos/seed/snacks-hero/1920/1080" alt="Assortment of snacks" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-yellow-900">Treat Yourself</h1>
                        <p className="mt-4 text-lg max-w-xl text-yellow-800">Find your favorite sweet and savory snacks for any craving.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Snacks" linkTo="/browse?category=snacks-confectionery" />
