...
const BeautyToolsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'beauty-tools' }, { page: 1, limit: 12 })
        ...
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-gray-800 text-white">
                     <img src="https://picsum.photos/seed/tools-hero/1920/1080" alt="Beauty tools" className="absolute inset-0 w-full h-full object-cover opacity-50"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-display">Professional Beauty Tools</h1>
                        <p className="mt-4 text-lg max-w-xl">Achieve salon-quality results at home with our range of high-tech beauty devices.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    <section>
                        <SectionHeader title="Shop Beauty Tools" linkTo="/browse?category=beauty-tools" />
