                ...
                >
                    ...
                    <div className="relative grid gap-6 lg:grid-cols-[1.65fr_1fr] lg:items-end">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="rounded-2xl border border-border bg-surface/90 p-4 shadow-soft">
                                <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-text-secondary">Spotlight commerce</p>
                                <p className="mt-2 text-sm leading-relaxed text-text-secondary">
                                    Turn product stories into Spotlight posts, then route shoppers straight into detail, store, cart, and checkout.
                                </p>
                                <div className="mt-4 flex flex-wrap gap-2">
                                    <Link to="/spotlight" className="rounded-full border border-border bg-background px-3 py-2 text-xs font-semibold text-text-primary hover:bg-surface-soft">
                                        Open Spotlight
                                    </Link>
                                    <Link to="/spotlight/create" className="rounded-full bg-primary px-3 py-2 text-xs font-semibold text-white hover:brightness-110">
                                        Create post
                                    </Link>
                                </div>
                            </div>
