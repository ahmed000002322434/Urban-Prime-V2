...
const BabyFoodPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'baby-food-formula' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-sky-100">
                     <img src="https://picsum.photos/seed/babyfood-hero/1920/1080" alt="Happy baby eating" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-sky-900">Nourishing Your Little One</h1>
                        <p className="mt-4 text-lg max-w-xl text-sky-800">Healthy and delicious options for every stage of your baby's development.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Baby Food & Formula" linkTo="/browse?category=baby-food-formula" />
