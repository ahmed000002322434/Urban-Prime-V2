...
const CookingEssentialsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'cooking-essentials' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-red-100">
                     <img src="https://picsum.photos/seed/cooking-hero/1920/1080" alt="Spices and oils" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/20">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-white">The Cook's Pantry</h1>
                        <p className="mt-4 text-lg max-w-xl text-gray-100">Stock your kitchen with the finest oils, spices, rice, and other cooking essentials.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Cooking Essentials" linkTo="/browse?category=cooking-essentials" />
...
export default CookingEssentialsPage;