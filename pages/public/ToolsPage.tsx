...
const ToolsPage: React.FC = () => {
  ...
  const toolsCategory = allCategories.find(c => c.id === 'tools');
  const subCategories = toolsCategory?.subcategories || [];
      ...
      <section ref={heroRef} className="animate-reveal bg-white dark:bg-dark-surface">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 text-center">
          ...
          <p className="mt-6 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            From major construction to weekend DIY projects, find the right tool for the job without breaking the bank.
          </p>
        </div>
      </section>
