...
const MakeupPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'makeup' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-pink-50">
                     <img src="https://picsum.photos/seed/makeup-hero/1920/1080" alt="Makeup products" className="absolute inset-0 w-full h-full object-cover opacity-80"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-pink-900">Create Your Canvas</h1>
                        <p className="mt-4 text-lg max-w-xl text-pink-800">Express yourself with our vibrant and versatile collection of makeup.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    <section>
                        <SectionHeader title="Shop Makeup" linkTo="/browse?category=makeup" />
