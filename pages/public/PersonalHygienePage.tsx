...
const PersonalHygienePage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'personal-hygiene' }, { page: 1, limit: 12 })
        ...
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-blue-50">
                     <img src="https://picsum.photos/seed/hygiene-hero/1920/1080" alt="Personal hygiene products" className="absolute inset-0 w-full h-full object-cover opacity-80"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-blue-900">Personal Hygiene Essentials</h1>
                        <p className="mt-4 text-lg max-w-xl text-blue-800">Everyday necessities to keep you feeling fresh and clean.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    <section>
                        <SectionHeader title="Shop Personal Hygiene" linkTo="/browse?category=personal-hygiene" />
