...
const BeveragesPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'beverages' }, { page: 1, limit: 12 })
        ...
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-blue-100">
                     <img src="https://picsum.photos/seed/beverages-hero/1920/1080" alt="Refreshing beverages" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-blue-900">Quench Your Thirst</h1>
                        <p className="mt-4 text-lg max-w-xl text-blue-800">From morning coffee to evening tea, find your favorite drinks here.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Beverages" linkTo="/browse?category=beverages" />
