...
const CleaningHouseholdPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'cleaning-household' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-cyan-100">
                     <img src="https://picsum.photos/seed/cleaning-hh-hero/1920/1080" alt="Sparkling clean home" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-cyan-900">Sparkling Clean</h1>
                        <p className="mt-4 text-lg max-w-xl text-cyan-800">All the essentials you need to keep your home shining.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Cleaning & Household" linkTo="/browse?category=cleaning-household" />
