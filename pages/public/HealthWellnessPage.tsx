...
const HealthWellnessPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'health-wellness' }, { page: 1, limit: 12 })
    ...
    return (
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-teal-50">
                     <img src="https://picsum.photos/seed/wellness-hero/1920/1080" alt="Health and wellness products" className="absolute inset-0 w-full h-full object-cover opacity-80"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-teal-900">Invest in Your Well-being</h1>
                        <p className="mt-4 text-lg max-w-xl text-teal-800">Discover products that support a healthy and balanced lifestyle.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-16">
                    <section>
                        <SectionHeader title="Shop Health & Wellness" linkTo="/browse?category=health-wellness" />
