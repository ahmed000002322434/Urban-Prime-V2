...
const DairyProductsPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        itemService.getItems({ category: 'dairy-products' }, { page: 1, limit: 12 })
        ...
        <>
            ...
            <div className="bg-white dark:bg-dark-background animate-fade-in-up">
                <section ref={heroRef} className="animate-reveal relative h-[50vh] bg-blue-50">
                     <img src="https://picsum.photos/seed/dairy-hero/1920/1080" alt="Dairy products like milk and cheese" className="absolute inset-0 w-full h-full object-cover"/>
                    <div className="relative h-full flex flex-col items-center justify-center text-center p-4 bg-black/10">
                        <h1 className="text-5xl md:text-6xl font-extrabold font-serif-display text-blue-900">Fresh from the Farm</h1>
                        <p className="mt-4 text-lg max-w-xl text-blue-800">Your daily dose of dairy, from fresh milk and yogurt to artisan cheeses.</p>
                    </div>
                </section>

                <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <section>
                        <SectionHeader title="Shop Dairy" linkTo="/browse?category=dairy-products" />
